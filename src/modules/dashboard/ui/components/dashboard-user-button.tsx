...
const DashboardUserButton = () => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="rounded-lg border border-border/10 p-3 w-full flex items-center justify-between hover:bg-white/10 bg-white/5 overflow-hidden">
        {data.user.image ? (
